...
<body>
	<div class="container">
		<h1>edition trajet</h1>

		<form:form action="${ctx}/trajet" method="post"
			modelAttribute="trajet">
			...
			<c:if test="${trajet.getClass().name=='model.Typetrajet'}">
			...
			<div>
				...
				<a href="${ctx}/trajet" class="btn btn-outline-warning">annuler</a>
			</div>
		</form:form>
	</div>
</body>
